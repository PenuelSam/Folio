...
const Projects = () => {    
  ...
  return (
    <div className='w-full h-full max-w-[1400px] mx-auto md:px-0  my-10 project-section'>
      ...
      <h1 className='font-HelveticaMid font-bold md:text-[64px] text-[25px] px-3  leading-[76.81px] tracking-[-0.02em] text-black text-center uppercase'>Featured Projects</h1>
